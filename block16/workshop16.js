...
function findItemByName() {
  //const findItemById = items.find((id) => id > 0);  <---
      //console.log(findItemById);  <---- think this is ^^ right
...
function capitalizeNames() {
  ...
  });                               //^^^       ^^^ how would we know to use this. never heard of any of them before?
}
...
function getItemPriceByName(name) {
  ...
  return item ? item.price : "Item not found";
            //^^ why this, don't remember what this is?
}
